...
from keras.layers import Input, Conv2D, Activation, Reshape, BatchNormalization
...
class MaxUnpooling2D(Layer):
    ...
    def call(self, inputs, output_shape=None):
        ...
        input_shape = K.shape(updates)  # Removed out_type argument
        ...
        updates_size = tf.size(updates)  # Changed from K.size to tf.size
