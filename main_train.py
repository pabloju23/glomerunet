...
train_img_patchesD2 = np.load('/scratch.local/juanp/glomeruli/dataset/train_imgD2_v2_positive.npy')
train_masks_patchesD2 = np.load('/scratch.local/juanp/glomeruli/dataset/train_maskD2_v2_positive.npy')
